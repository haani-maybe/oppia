...
test.describe('Lesson Creator Profile Deletion', function () {
  ...
  test('should trigger draft exploration deletion and preserve correct ownership after account deletion', async function () {
